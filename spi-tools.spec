...
Version  : 0.8.2
Release  : 4
URL      : https://github.com/cpb-/spi-tools/archive/0.8.2.tar.gz
Source0  : https://github.com/cpb-/spi-tools/archive/0.8.2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1533909301
